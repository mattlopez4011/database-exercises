...
SELECT name AS 'Albums with less than 20 millions certified sales', sales  FROM albums WHERE sales <= 20.0;

-- All the albums with a genre of "Rock". Why do these query results not include albums with a genre of "Hard rock" or "Progressive rock"?
SELECT artist, genre, name AS 'Rock Albums' FROM albums WHERE genre LIKE '%Rock%';
-- SELECT artist, genre, name AS 'Rock Albums' FROM albums WHERE genre = 'Rock';